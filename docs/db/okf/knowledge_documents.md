...
description: "Postgres table `knowledge_documents`: 14 columns. References organizations."
...
Postgres table `knowledge_documents`: 14 columns. References organizations.
