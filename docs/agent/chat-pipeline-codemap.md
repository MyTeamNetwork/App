...
| `src/lib/ai/untrusted-text.ts` | Structural neutralization for untrusted RAG chunks and grounding fallbacks | `neutralizeUntrustedText`, `UNTRUSTED_CHUNK_OPEN`, `UNTRUSTED_CHUNK_CLOSE` |
